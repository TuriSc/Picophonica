...
void synth_control(uint8_t key)
{
  switch(key){
    ...
    case PRESET_2:                                              load_preset(2);           break;
    case PRESET_3:                                              load_preset(3);           break;
    case PRESET_4:                                              load_preset(4);           break;
    case PRESET_5:                                              load_preset(5);           break;
    case PRESET_6:                                              load_preset(6);           break;
    case PRESET_7:                                              load_preset(7);           break;
    case PRESET_8:                                              load_preset(8);           break;
    case PRESET_9:                                              load_preset(9);           break;
  }
}
